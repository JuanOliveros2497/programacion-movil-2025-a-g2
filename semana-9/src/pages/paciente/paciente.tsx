  ...
  return (
    <IonPage>
      <IonHeader>
        ...
        />
          <IonTitle>Registro Paciente</IonTitle>
        </IonToolbar>
      ...
      <IonContent className="ion-padding">
        ...
        <IonItem>
          <IonLabel position="stacked">Número de historia clínica</IonLabel>
          <IonInput
        ...
        <IonItem>
          <IonLabel position="stacked">Tipo de afiliación (EPS, particular)</IonLabel>
          <IonInput
